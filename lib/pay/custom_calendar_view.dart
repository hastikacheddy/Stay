        ...
        Expanded(
          child: Center(
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: ThemeProvider.of(context).focusColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: startDate != null && endDate != null
                                  ...
                                  ? ThemeProvider.of(context).focusColor.withOpacity(0.4)
                                  : Colors.transparent
                                  : Colors.transparent,
                    ...
                    Material(
                      ...
                      child: InkWell(
                        ...
                        child: Padding(
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date) ? ThemeProvider.of(context).focusColor : Colors.transparent,
                              borderRadius: const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
